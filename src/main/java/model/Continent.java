...
public class Continent {
    ...
    /**
     * This is the Constructor of the class which stores the ID Name and
     * ContinentControl Value to that Continent Object
     * It also initializes the CountryList which later stores all the countries
     * belonging to that particular continent
     * 
     * @param p_Name                  Name of the Continent
     * @param p_ContinentControlValue Integer representing the ContinentControl
     *                                Value
     */
