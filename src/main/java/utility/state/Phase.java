...
public abstract class Phase {
    ...
    /**
     * It is the tournament method of the game engine to play the game in tournament
     * mode.
     * It does this if the command is applicable for that particular phase or else
     * it will simply return String stating invalid command
     *
